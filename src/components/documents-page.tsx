...
export function DocumentsPage() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-950 p-4">
      ...
      <p className="mt-1 text-[11px] text-slate-400">Active project: {selectedProjectName || "None selected"}</p>

      <div className="mt-4 grid gap-2 rounded border border-white/10 bg-slate-900/40 p-3 md:grid-cols-[1fr]">
        <div>
          ...
          <p className="mt-1 text-[11px] text-slate-400">Project switch happens in Projects page.</p>
        </div>
      </div>
